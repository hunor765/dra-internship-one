...
<section class="hero">
  <h1>Grow something wonderful this season</h1>
  <p>Heirloom seeds, honest tools and peat-free soil — everything your garden needs, minus the guesswork.</p>
  <a class="btn" href="/category.php?id=seeds-bulbs"
     data-select-promotion data-promotion="<?= $promoJson ?>">Shop the Spring Sale</a>
...
<section style="margin-top:44px;">
  <div class="section-head">
    ...
    <a href="/category.php?id=seeds-bulbs">Browse all →</a>
  </div>
