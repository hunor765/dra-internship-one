...
<form id="shipping-form" class="checkout-layout" style="display:none;">
  <div class="form-card">
    <div class="form-grid">
      <div class="field"><label>First name</label><input name="first" value="Fern" required></div>
      <div class="field"><label>Last name</label><input name="last" value="Greenfield" required></div>
      <div class="field field--full"><label>Email</label><input name="email" type="email" value="fern@example.com" required></div>
      <div class="field field--full"><label>Street address</label><input name="address" value="12 Meadow Lane" required></div>
      <div class="field"><label>City</label><input name="city" value="Rootstown" required></div>
      <div class="field"><label>Postcode</label><input name="zip" value="GR0 1WN" required></div>
